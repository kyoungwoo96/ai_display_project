...
# class CUB_200_2011(Dataset):
#     def __init__(self, train=True, index_path=None, index=None, base_sess=None):
#         self.train = train

#         image_file = './data/CUB_200_2011/images.txt'
#         split_file = './data/CUB_200_2011/train_test_split.txt'
#         class_file = './data/CUB_200_2011/image_class_labels.txt'
...
#         if self.train:
#             for k in train_idx:
#                 image_path = os.path.join('./data/CUB_200_2011/images', id2image[k])
#                 self.data.append(image_path)
#                 self.targets.append(int(id2class[k]) - 1)
#                 self.data2label[image_path] = (int(id2class[k]) - 1)
